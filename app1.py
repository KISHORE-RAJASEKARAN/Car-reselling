...
def main():
    ...
    MILEAGE=st.number_input("Insert Mileage in Kmpl")
    ...
    ENGINE=st.number_input("Insert Engine in CC")
    SEATS=st.number_input("Insert No of Seats")
    ...
    st.success('The predicted price is {} lakhs'.format(result))
    if st.button("About"):
